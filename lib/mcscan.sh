...
EOS
    ...
    function search_microsynteny() {
        ...
        echo "0.5, 0.4, 0, left, center, #D55E00, 1, ${seq_li[0]}" >> "blocks.layout"
        echo "0.5, 0.6, 0, left, center, #0072B2, 1, ${seq_li[1]}" >> "blocks.layout"
...
EOS
    ...
    function search_microsynteny() {
        ...
        echo "0.5, 0.3, 0, left, center, #D55E00, 1, ${seq_li[1]}" >> "blocks.layout"
        echo "0.5, 0.7, 0, left, center, #0072B2, 1, ${seq_li[2]}" >> "blocks.layout"
        echo "# edges" >> "blocks.layout"
        echo "e, 0, 1" >> "blocks.layout"
